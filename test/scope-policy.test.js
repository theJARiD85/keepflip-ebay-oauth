...
test('uses only the scopes required by the connected-account and finance flow', () => {
...
test('overwrites a stale broad OAuth scope environment value', () => {
  ...
  assert.equal(
    value,
    'https://api.ebay.com/oauth/api_scope https://api.ebay.com/oauth/api_scope/commerce.identity.readonly https://api.ebay.com/oauth/api_scope/sell.inventory https://api.ebay.com/oauth/api_scope/sell.finances',
  );
